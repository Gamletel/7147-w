...
//		add_action( 'wp_enqueue_scripts', array( $this, 'styles' ) );
		...
		// Addon display.
		add_action( 'woocommerce_after_single_product_summary', array( $this, 'display' ), 20 );
		add_action( 'woocommerce_after_single_product_summary', array( $this, 'reposition_display_for_variable_product' ), 20 );
		add_action( 'woocommerce_product_addons_end', array( $this, 'totals' ), 20 );
		add_action( 'woocommerce_product_addons_end', array( $this, 'notices' ), 20 );
