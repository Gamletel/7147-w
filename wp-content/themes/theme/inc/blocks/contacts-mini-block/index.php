...
class ContactsMiniBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'contacts-mini-block',
				'title'             => 'Блок: Контакты (мини)',
				'description'       => 'Контакты (мини)',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/contacts-mini-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/contacts-mini-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
