        ...
        <div class="single-product__bottom-block block-margin">
            <div class="content">
                <?php if (!empty($description)) { ?>
                    <div class="single-product__description alignfull">
                        <div class="description__bg-left">
                            <img src="<?= get_theme_file_uri(); ?>/assets/images/description-bg-left.png" alt="">
                        </div>

                        <div class="description__bg-right">
                            <img src="<?= get_theme_file_uri(); ?>/assets/images/description-bg-right.png" alt="">
                        </div>
